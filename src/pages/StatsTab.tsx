...
export const StatsTab: React.FC<StatsTabProps> = ({ logs, points }) => {
        ...
        <div className="space-y-4 animate-in slide-in-from-right-4">
            ...
            <div className="grid grid-cols-2 gap-3">
                ...
                <StatsCard
                    icon={Award}
                    label="周训练次数"
                    value={weeklyStats.trainingCount}
                    color="purple"
                />
            </div>
            ...
            {logs.length === 0 ? <div className="text-center py-10 text-gray-400 dark:text-gray-500 text-sm border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-xl">暂无数据</div> : logs.map((log, i) => (
                <div key={i} className="bg-white dark:bg-gray-800 p-3 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm flex justify-between items-center transition-colors">
