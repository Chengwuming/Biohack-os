...
export default function App() {
    ...
    const [lastActiveDate, setLastActiveDate] = usePersistentState<string>('thu_active_date', new Date().toLocaleDateString());
    const [dailyState, setDailyState] = usePersistentState<DailyState>('thu_daily_state', {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-sans text-gray-800 dark:text-gray-100 pb-24 transition-colors">
            {/* Top Bar */}
            ...
            <div className="p-4 max-w-md mx-auto">
                {activeTab === 'EAT' && (
                    <EatTab
                        dailyState={dailyState} setDailyState={setDailyState}
                ...
                {activeTab === 'TRAIN' && (
                    <TrainTab
                        workoutWeights={workoutWeights} setWorkoutWeights={setWorkoutWeights}
                        setPoints={setPoints} setLogs={setLogs}
                    />
                )}
                {activeTab === 'STATS' && (
